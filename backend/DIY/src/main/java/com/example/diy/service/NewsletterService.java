...
//    private static final String BASE_URL_FRONTEND = "http://localhost:4200";
    ...
    private String getImageUrl(String picturePath) {
        // אם יש נתיב, נשתמש ב-ID של הפרויקט כדי ליצור תמונה רנדומלית יציבה
        // כך שכל פרויקט יקבל תמונה שונה אך קבועה.
        if (picturePath != null && !picturePath.isEmpty()) {

            // נשתמש ב-hashCode של הנתיב כדי לקבל מספר רנדומלי עבור התמונה
            int seed = picturePath.hashCode();

            // בונה URL: https://picsum.photos/seed/<SEED>/120/120
            // גודל התמונה הוגדר כ-120x120 פיקסלים, התואם לכרטיסים שבנית.
            return BASE_URL + "/seed/" + Math.abs(seed) + "/120/120";
        }

        // אם אין נתיב תמונה, נחזיר תמונה רנדומלית קבועה
        return BASE_URL + "/seed/999/120/120";
    }
}
